...
const Footer = () => {
    return (
        <footer className="bg-black flex flex-wrap justify-center lg:justify-between py-8 px-16 gap-16">
            <div className="flex flex-col text-center gap-8">
                <div className="flex flex-wrap justify-center gap-8 items-center">
                    <Image src="/logos/mythography/mythography-dark.svg" alt="" width="92" height="92" className="w-16 lg:w-20"></Image>
            ...
            <div className="flex items-end justify-center flex-wrap-reverse gap-16">
